...
@Component(immediate = true, property = { "com.liferay.portlet.display-category=category.sample",
		...
		"javax.portlet.display-name=EdelweissFundsCalculator", "javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/funds_calculator.jsp",
		"javax.portlet.name=" + EdelweissFundsPortletKeys.EDELWEISSFUNDSCALCULATORPORTLET,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user" }, service = Portlet.class)
public class EdelweissFundsCalculatorPortlet extends MVCPortlet {
	...
	private Log log = LogFactoryUtil.getLog(EdelweissFundsCalculatorPortlet.class);
}
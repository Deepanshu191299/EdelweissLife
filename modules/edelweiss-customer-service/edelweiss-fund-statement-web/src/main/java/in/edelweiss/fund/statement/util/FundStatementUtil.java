package in.edelweiss.fund.statement.util;
 ...
 * @author Abhijit AA
 * 
 *         The class will contain the API Implementation of Fund Statement Related APIs.
 */
public class FundStatementUtil {

	/**
	 * private constructor to hide the implicit public one
	 * 
	 */
	private FundStatementUtil() {

	}

	/**
	 * This method is used to call the Customer Policy Data API to get customer details.
	 *
	 * @param inputType
	 * @param inputValue
	 * @param dateOfBirth
	...
	private static Log logger = LogFactoryUtil.getLog(FundStatementUtil.class);
}

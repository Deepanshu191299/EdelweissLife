package in.edelweiss.fund.statement.resources;
...
@Component(immediate = true, property = { "javax.portlet.name=" + FundStatementPortletKeys.FUNDSTATEMENT,
		"mvc.command.name="
				+ FundStatementPortletKeys.DOWNLOAD_URL_MVC_RESOURCE_COMMAND }, service = MVCResourceCommand.class)
	...
	protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		try {
			...
			if (Validator.isNotNull(documentId)) {
				Map<String, Object> responseMap = FundStatementUtil.generateDocumentURL(documentId);

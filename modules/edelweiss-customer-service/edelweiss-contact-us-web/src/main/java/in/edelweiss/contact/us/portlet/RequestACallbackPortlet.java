...
/**
 * This portlet will be used to submit the Request A Callback form and call the API Required.
 * 
 * @author Abhijit AA
 */
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Request A Callback",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/jsp/request-a-callback.jsp",
		"javax.portlet.name=" + ContactUsPortletKeys.REQUESTACALLBACK,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class RequestACallbackPortlet extends MVCPortlet {
	
	/**
	 * This method will get the values of the form and 
	 * submit the details to the Callback API 
	 * 
	 * @param actionRequest
	...
	public void processAction(ActionRequest actionRequest, ActionResponse actionResponse)
		...
		try {
			if (Validator.isNotNull(detailsJSON)) {
				String endpoinURL = ConfigurationUtil.getApiURLConfiguration().getCallbackFormSubmitURL();
			...
			logger.error("Exception occured while submitting Request Callback form : " + exception.getMessage());

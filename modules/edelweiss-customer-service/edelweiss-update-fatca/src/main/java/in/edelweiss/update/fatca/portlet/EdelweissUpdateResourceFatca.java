...
@Component(immediate = true, property = { 
		...
		"mvc.command.name=/get/multipleLoginData"
		}, service = MVCResourceCommand.class)
public class EdelweissUpdateResourceFatca extends BaseMVCResourceCommand{
	@Reference
	private EdelweissTokioCommonApi edelweissTokioCommonApi;
	private static Log logger = LogFactoryUtil.getLog(EdelweissUpdateResourceFatca.class);
	
	@Override
	protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
			throws Exception {
		// TODO Auto-generated method stub
		logger.debug("inside doserver resource::::::");

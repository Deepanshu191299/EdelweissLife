package in.edelweiss.premium.paid.certificate.util;
 ...
 */
public class PremiumPaidCertificateUtil {

	/**
	 * private constructor to hide the implicit public one
	 * 
	 */
	private PremiumPaidCertificateUtil() {
	...
	private static Log logger = LogFactoryUtil.getLog(PremiumPaidCertificateUtil.class);
}

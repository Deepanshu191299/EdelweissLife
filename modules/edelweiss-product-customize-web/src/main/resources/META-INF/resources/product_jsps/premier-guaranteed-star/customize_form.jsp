...
<%@ include file="/product_jsps/premier-guaranteed-star/edit_basic_details.jsp" %>
...
<c:choose>
	<c:when test="${isProductSelected}">
										...
										<div class="labelInputGroup">
											...
											<div class="select-container ">
												<select class="form-control" id="<portlet:namespace />policyFor" name="<portlet:namespace />policyFor">
													...
													<c:if test="${(basicDetailsMap['age']<=50) || (basicDetailsMap['age']>50 && curPayFor.value!=5)}">
		...
		<%@ include file="/product_jsps/premier-guaranteed-star/family-details.jsp"%>
		<%@ include file="/product_jsps/premier-guaranteed-star/product_features.jsp"%>
		<%@ include file="/product_jsps/premier-guaranteed-star/product_riders.jsp"%>
	</c:when>
	<c:otherwise>
...
<script type="text/javascript">
	...
	$("#<portlet:namespace/>proceedBtn").click(function() {
		...
		incomePayoutFrequency = $('#<portlet:namespace />incomePayoutFrequency').find(":selected").text();
	    ...
	    webengage.track(eventname, {
	 	    "Product Name" : productName.toString(),
	 	  	...
	 	  	"Income Payout Frequency" : incomePayoutFrequency.toString(),
...
--%>
<script src="<%=request.getContextPath()%>/product_jsps/premier-guaranteed-star/js/pgs-main.js?t=<%=EdelweissProductCustomizeConstants.CURRENT_TIME_STAMP%>"></script>
<script src="<%=request.getContextPath()%>/product_jsps/premier-guaranteed-star/js/pgs-basic-detail.js?t=<%=EdelweissProductCustomizeConstants.CURRENT_TIME_STAMP%>"></script>

...
<portlet:resourceURL var="addRisingStarBenefitURL" id="/add/risingStarBenefit"></portlet:resourceURL>
...
<c:choose>
	<c:when test="${isProductSelected}">
		<form name="<portlet:namespace />customizeForm" id="<portlet:namespace />customizeForm" method="post" action="${saveInvestmentDetails}">
			...
			<input type="hidden" class="form-control" id="<portlet:namespace />isFormSubmitPending" name="<portlet:namespace />isFormSubmitPending" value="false" />
			<input type="hidden" class="form-control" id="<portlet:namespace />isPdfByte" name="<portlet:namespace />isPdfByte" value="Y" />
		...
		<%@ include file="wealth-plus-family-details.jsp"%>
...
$(document).ready(function () {
	...
	var config = new Object({}),
		 ...
		 risingStarModalJEl = "#" + namespace + "risingStarModal",
		 ...
		 isRisingStarBenefitOptedJEl = "#" + namespace + "isRisingStarBenefitOpted",
		 familyModalCloseJEl = "#" + namespace + "familyModalClose",
		 errorMessageContainerJEl = "#errorMessageContainer",
		 addRisingStarBenefitURL = "${addRisingStarBenefitURL}",
		 ...
		 config.policyTermPolicyForRelData = '${policyTermDataMap}';
		 config.policyForRelData = '${payForDataMap}';
		 ...
		 config.risingStarModalJEl = risingStarModalJEl;
		 ...
		 config.isRisingStarBenefitOptedJEl = isRisingStarBenefitOptedJEl;
		 config.isRisingStarBenefitOpted = "${basicDetailsMap['isRisingStarBenefitOpted']}";
		 config.familyModalCloseJEl = familyModalCloseJEl;
		 config.errorMessageContainerJEl = errorMessageContainerJEl;
		 config.addRisingStarBenefitURL = addRisingStarBenefitURL;
...
<script src="<%= request.getContextPath()%>/product_jsps/wealth-plus/js/wealth-plus-main.js?t=${currentTimeStamp}"></script>
<script src="<%= request.getContextPath()%>/product_jsps/wealth-plus/js/wealth-plus-basic-detail.js?t=${currentTimeStamp}"></script>

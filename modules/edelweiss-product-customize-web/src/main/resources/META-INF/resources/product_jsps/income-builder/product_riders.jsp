				...
				%>
					...
					<div class="m-2 custom-card">
						...
						<div id="<portlet:namespace/>riderPremiumDetails_<%=riderId %>" class="row mt-2 price-tile">
							...
							<p>	<span id="<portlet:namespace/>riderPriceAmount_<%=riderId %>"></span></p>
							</div>
						...
						<div class="family-income-benefit-error overlay-card card-body my-family-body" id="<portlet:namespace/>WOPSinglePayError_<%=riderId %>" style="display:none">
 							<p class="overlay-card-text"><liferay-ui:message key="label-not-applicable-with-single-pay-for-WOP" arguments="<%= productRider.getString("title", StringPool.BLANK)  %>"/></p>
						</div>
						<div class="family-income-benefit-error overlay-card card-body my-family-body" id="<portlet:namespace/>PWBSinglePayError_<%=riderId %>" style="display:none">
 							<p class="overlay-card-text"><liferay-ui:message key="label-not-applicable-with-single-pay-for-PWB" arguments="<%= productRider.getString("title", StringPool.BLANK)  %>"/></p>
						</div>

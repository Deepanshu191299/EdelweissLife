...
<c:choose>
	<c:when test="${isProductSelected}">
					...
					<div class="edelweissFormInner d-flex">
						<div id="edelweissTokioForm1" class="edelweissTokioForm">
							<div class="row owl-carousel owl-theme">
										...
										<div class="labelInputGroup">
											...
											<div class="select-container ">
												<select class="form-control" id="<portlet:namespace />policyFor" name="<portlet:namespace />policyFor">
													<c:forEach var="curPayFor" items="${gisPayForPicklistData}">
								...
								<c:if test="${productCustomizeSummaryData['productDefaultValueData'].isGISIncomeStartPointApplicable()}">
									<div class=" item" id="<portlet:namespace />incomeStartPointDiv">
										<div class="labelInputGroup">
											<div class="labelGroup">
												<label for="<portlet:namespace />incomeStartPoint" class="pform-title mb-0"><liferay-ui:message key="income-start-point-label" /></label>
												<p class="premiuim-small-text">
													<liferay-ui:message key="income-start-point-description-label" />
												</p>
											</div>
											<div class="select-container ">
												<select class="form-control" id="<portlet:namespace />incomeStartPoint" name="<portlet:namespace />incomeStartPoint">
													<c:forEach var="curISP" items="${gisIncomeStartPointPicklistData}">
														<option data-name="${curISP.value}" value="${curISP.key}"
															${productCustomizeSummaryData['productDefaultValueData'].gISIncomeStartPoint.key == curISP.key ? 'selected' : ''}>
															${curISP.value}</option>
													</c:forEach>
												</select>
											</div>
								...
								<c:if test="${productCustomizeSummaryData['productDefaultValueData'].isGISIncomeDurationApplicable()}">
									<div class=" item" id="<portlet:namespace />incomeDurationdiv">
										<div class="labelInputGroup">
											<div class="labelGroup">
												<label for="<portlet:namespace />incomeDuration" class="pform-title mb-0"><liferay-ui:message key="income-duration-label" /></label>
												<p class="premiuim-small-text">
													<liferay-ui:message key="income-duration-description-label" />
												</p>
											</div>
											<div class="select-container ">
												<select class="form-control" id="<portlet:namespace />incomeDuration" name="<portlet:namespace />incomeDuration">
													<c:forEach var="curincomeDuration" items="${gisIncomeDurationPicklistData}">
														<option data-name="${curincomeDuration.value}" value="${curincomeDuration.key}"
															${productCustomizeSummaryData['productDefaultValueData'].gISIncomeDuration.key == curincomeDuration.key ? 'selected' : ''}>${curincomeDuration.value}</option>
													</c:forEach>
												</select>
											</div>
										</div>
									...
									<div class=" item" id="<portlet:namespace />familyIncomeBenefitDiv">
										<div class="labelInputGroup">
											<div class="labelGroup">
												...
												<p class="premiuim-small-text">
													<liferay-ui:message key="family-income-benefit" />
												</p>
											</div>
											<div class="select-container ">
												<select class="form-control" id="<portlet:namespace />familyIncomeBenefit" name="<portlet:namespace />familyIncomeBenefit">
													<c:forEach var="curfamilyIncomBenefit" items="${gisFamilyIncomBenefitPicklistData}">
								...
								<c:if test="${productCustomizeSummaryData['productDefaultValueData'].isGISIncomeBenefitPayoutTypeApplicable()}">
									<div class=" item" id="<portlet:namespace />incomeBenefitPayoutTypeDiv">
										<div class="labelInputGroup">
											<div class="labelGroup">
												<label for="<portlet:namespace />incomeBenefitPayoutType" class="pform-title mb-0"><liferay-ui:message key="income-Benefit-Payout-Type-Label" /></label>
												<p class="premiuim-small-text">
													<liferay-ui:message key="income-benefit-payout-type-desc" />
												</p>
											</div>
											<div class="select-container ">
												<select class="form-control" id="<portlet:namespace />incomeBenefitPayoutType" name="<portlet:namespace />incomeBenefitPayoutType">
													<c:forEach var="curincomeBenefitPayoutType" items="${gisIncomeBenefitPayoutTypePicklistData}">
														<option data-name="${curincomeBenefitPayoutType.value}" value="${curincomeBenefitPayoutType.key}"
															${productCustomizeSummaryData['productDefaultValueData'].gISIncomeBenefitPayoutType.key == curincomeBenefitPayoutType.key ? 'selected' : ''}>${curincomeBenefitPayoutType.value}</option>
													</c:forEach>
												</select>
											</div>
										</div>
								...
								<c:if test="${productCustomizeSummaryData['productDefaultValueData'].isGISLumpSumBenefitApplicable()}">
										...
										<div class="labelInputGroup">
											...
											<div class="select-container ">
												<select class="form-control" id="<portlet:namespace />lumpSumBenefit" name="<portlet:namespace />lumpSumBenefit">
													<c:forEach var="curlumpSumBenefit" items="${gisLumpSumBenefitPicklistData}">
														<option data-name="${curlumpSumBenefit.value}" value="${curlumpSumBenefit.key}"
															${productCustomizeSummaryData['productDefaultValueData'].gISLumpSumBenefit.key == curlumpSumBenefit.key ? 'selected' : ''}>${curlumpSumBenefit.value}</option>
													</c:forEach>
												</select>
											</div>
										</div>
		...
		<%@ include file="/product_jsps/guaranteed-income-star/family-details.jsp"%>
		<%@ include file="/product_jsps/guaranteed-income-star/product_features.jsp"%>
		<%@ include file="/product_jsps/guaranteed-income-star/product_riders.jsp"%>
	</c:when>
	<c:otherwise>
...
$(document).ready(function () {
	...
	var config = new Object({}),
		 ...
		 incomeBenefitPayoutTypeEl=namespace + "incomeBenefitPayoutType",
		 ...
		 incomeBenefitPayoutTypeJEl= "#" + incomeBenefitPayoutTypeEl,
		 ...
		 config.incomeBenefitPayoutTypeEl=incomeBenefitPayoutTypeEl;
		 ...
		 config.incomeBenefitPayoutTypeJEl=incomeBenefitPayoutTypeJEl;
...
<script src="<%=request.getContextPath()%>/product_jsps/guaranteed-income-star/js/gis-main.js?t=<%=EdelweissProductCustomizeConstants.CURRENT_TIME_STAMP%>""></script>
<%-- <script src="<%=request.getContextPath()%>/js/basic_detail.js?t=${currentTimeStamp}"></script> --%>
<script src="<%=request.getContextPath()%>/product_jsps/guaranteed-income-star/js/gis-basic-details.js?t=<%=EdelweissProductCustomizeConstants.CURRENT_TIME_STAMP%>""></script>
...
<script type="text/javascript">
	...
	$("#<portlet:namespace/>proceedBtn").click(function() {
		...
		policyTerm = '${productCustomizeSummaryData['productDefaultValueData'].getPolicyTerm()}';
		benefitDuration = $('#<portlet:namespace />incomeDuration').find(":selected").text();
		benefitStartPoint = $('#<portlet:namespace />incomeStartPoint').find(":selected").text();
		...
		benefitType = $('#<portlet:namespace />incomeBenefitPayoutType').find(":selected").text();

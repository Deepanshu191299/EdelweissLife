			...
			<div class="fund-equity250-inner">
				<div class="fund-equity250-heading-box mb-3">
					...
					<div class="fund-equity250-customize-wrapper d-flex pb-md-4 pt-md-3"
						...
						<a href="javascript:;" onclick="showProductRiders()"><liferay-ui:message
								key="label-choose-rider" /></a>
					</div>
																	...
																	<div class="table-responsive pd-x-15">
																		<table id="planIncomeBenefitsBreakupTable"
																			...
																			<thead>
																				<tr>
																					<th>Policy Year</th>
																					<th>Guaranteed Accrual Additions</th>
																					<th>Large Premium Benefit</th>
																					<th>Sum Assured on Benefit</th>
																					<th>Maturity Benefit</th>
																				</tr>
																			</thead>
																			<tbody
																				id="<portlet:namespace/>planIncomeBenefitsBreakupTableBody"

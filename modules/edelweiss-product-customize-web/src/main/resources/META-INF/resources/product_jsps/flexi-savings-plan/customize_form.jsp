...
<script>
	...
	var investmentOptionsRelationMap = '${productCustomizeSummaryData["productIsyandPtRelationship"]}';
	try{
		investmentOptionsRelationMap = JSON.parse(investmentOptionsRelationMap);
	}
	catch(err){
		console.warn(err)
	}
	...
	defaultValues.set("planOption","${productCustomizeSummaryData['productDefaultValueData'].policyOption.key}");
	...
	defaultValues.set("incomeStartYear","${productCustomizeSummaryData['productDefaultValueData'].incomeStartYear.key}");
...
<c:if test="${not empty basicDetailsMap }" >
	<liferay-util:include page="/product_jsps/flexi-savings-plan/customer_details.jsp" servletContext="<%=application%>" />
 ...
 <c:choose>
    <c:when test = "${isProductSelected}">
		<liferay-util:include page="/product_jsps/flexi-savings-plan/product_customize_fields.jsp" servletContext="<%=application%>" />
		<liferay-util:include page="/product_jsps/flexi-savings-plan/product_features.jsp" servletContext="<%=application%>" />
		<liferay-util:include page="/product_jsps/flexi-savings-plan/product_riders.jsp" servletContext="<%=application%>" />
		<liferay-util:include page="/product_jsps/flexi-savings-plan/error_message_model.jsp" servletContext="<%=application%>" />
		<liferay-util:include page="/product_jsps/flexi-savings-plan/maturity_benefits_breakup_model.jsp" servletContext="<%=application%>" />
	</c:when>
    <c:otherwise>
...
<script src="<%=request.getContextPath()%>/product_jsps/flexi-savings-plan/js/fsp-main.js?t=<%=EdelweissProductCustomizeConstants.CURRENT_TIME_STAMP%>"></script>
<script src="<%=request.getContextPath()%>/product_jsps/flexi-savings-plan/js/fsp-riders.js?t=<%=EdelweissProductCustomizeConstants.CURRENT_TIME_STAMP%>"></script>
<script src="<%=request.getContextPath()%>/product_jsps/flexi-savings-plan/js/fsp-basic-detail.js?t=<%=EdelweissProductCustomizeConstants.CURRENT_TIME_STAMP%>"></script>
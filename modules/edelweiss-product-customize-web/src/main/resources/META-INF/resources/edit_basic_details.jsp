            ...
            <form name="<portlet:namespace/>editSummaryForm"
              ...
              <div class="input-box mb-2"> <label>How do we address you?</label></div>
               <div class="radio_container" id="gender-wrapp">                  
                ...
                <div class="col-md-6 col-12">
                  ...
                  Name</label> <input type="text" class="form-control edelweiss-allow-aplha-space"
              ...
              <span class="underline"></span>
               ...
               <div class="col-md-12 col-12">
                 <div class="input-box mb-2"> <label>Select Investment Objective</label></div>
    			...
    			<div class="input-box mb-2"><label>You are investing for?</label></div>
                    ...
                    <li class="btn form-btn address-radio form-btn-slct" id="investing_for_family">
                     ...
                     <div class="col-md-12 col-12" id="investingFormFamily">                       
                      <div class="input-box mb-2">  <label> Who Do You Invest for ?</label></div>
                        <div class="radio_container">
                        <li class="btn form-btn p-0 address-radio">
                        <input type="radio" name="<portlet:namespace/>assuredRelation" id="investForSon" value="Son" data-name="Son" <c:if test="${basicDetailsMap['assuredRelation'] == 'Son'}"> checked </c:if>>
                            <label for="investForSon">Son</label>
                       </li>
                        <li class="btn form-btn p-0 address-radio">
                            <input type="radio" name="<portlet:namespace/>assuredRelation" id="investForDaughter" value="Daughter" data-name="Daughter" <c:if test="${basicDetailsMap['assuredRelation'] == 'Daughter'}"> checked </c:if>>
                 ...
                 <div class="col-12">
                    ...
                    <c:if test="${productMetaData['productName'] == 'Wealth Rise Plus' || productMetaData['productName'] == 'Capital Secure Plus'}">
	                    <div class="col-md-6 col-12" id="removeLittleChampWrapper">
	                    	<p><liferay-ui:message key="little-champ" /></p>
                    		<div class="radio_container">                  
			                	<input type="hidden" value="false" id="<portlet:namespace/>removeLittleChamp" name="<portlet:namespace/>removeLittleChamp">
			                    <label id="<portlet:namespace/>removeLittleChampBenefit"><liferay-ui:message key="remove" /></label>
			               </div>
	                    </div>
                    </c:if>
                    <c:if test="${productMetaData['productName'] == 'Wealth Plus'}">
	                    <div class="col-md-6 col-12" id="removeLittleChampWrapper">
	                    	<p><liferay-ui:message key="rising-star" /></p>
                    		<div class="radio_container">                  
			                	<input type="hidden" value="false" id="<portlet:namespace/>removeRisingStar" name="<portlet:namespace/>removeRisingStar">
			                    <label id="<portlet:namespace/>removeLittleChampBenefit"><liferay-ui:message key="remove" /></label>
			               </div>
	                    </div>
                    </c:if>
...
$("#save").click(function() {
		...
		childName = $('#<portlet:namespace />assuranceFullName').val();
		childDOB = $('#<portlet:namespace />assuranceDob').val();

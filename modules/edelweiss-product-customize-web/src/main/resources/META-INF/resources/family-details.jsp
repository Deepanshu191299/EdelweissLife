	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				...
				<button type="button" id="<portlet:namespace/>familyModalClose" class="close" data-dismiss="modal" aria-label="Close">
				 ...
				 <form name="<portlet:namespace/>familyDetailsForm" id="<portlet:namespace/>familyDetailsForm" method="POST">
					<div class="row">
                        ...
                        <div class="input-box"> 
								...
								<input class="form-control edelweiss-allow-aplha-space" type="text" name="<portlet:namespace/>investingForFullName" id="<portlet:namespace/>investingForFullName" 
									value="${basicDetailsMap['basicInvestingFor'] == 'Family' ? basicDetailsMap['assuranceFullName'] : ''}" 
									oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, '').replace(/(\..*)\./g, '$1');" onblur="if (this.value == '') {this.value = '';}" onfocus="if (this.value == '') {this.value = '';}">

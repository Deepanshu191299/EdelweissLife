...
public class SpouseDetails {
	...
	private String nriGstApplicableYn;
	...
	private String employmentDetailsId;
	...
	private String sourceIncomeOtherYn;
	...
	public String getNriGstApplicableYn() {
		return nriGstApplicableYn;
	}

	public void setNriGstApplicableYn(String nriGstApplicableYn) {
		this.nriGstApplicableYn = nriGstApplicableYn;
	}
	...
	public String getEmploymentDetailsId() {
		return employmentDetailsId;
	}

	public void setEmploymentDetailsId(String employmentDetailsId) {
	...
	public String getSourceIncomeOtherYn() {
		return sourceIncomeOtherYn;
	}

	public void setSourceIncomeOtherYn(String sourceIncomeOtherYn) {
		this.sourceIncomeOtherYn = sourceIncomeOtherYn;
	}
	...
	public String toString() {
		return "SpouseDetails [personalDetailsId=" + personalDetailsId + ", titleDataId=" + titleDataId
				+ ", detailTypeOf=" + detailTypeOf + ", firstName=" + firstName + ", middleName=" + middleName
				+ ", lastName=" + lastName + ", fullName=" + fullName + ", dob=" + dob + ", isSmokerYn=" + isSmokerYn
				...
				+ motherName + ", nationalityDataId=" + nationalityDataId + ", nationalityOther=" + nationalityOther
				+ ", ageProofDataId=" + ageProofDataId + ", ageProofOther=" + ageProofOther + ", qualificationDataId="
				...
				+ ", courseYear=" + courseYear + ", courseCollege=" + courseCollege + ", familyPhysicianName="
				+ familyPhysicianName + ", familyPhysicianAddressLine1=" + familyPhysicianAddressLine1
				+ ", familyPhysicianAddressLine2=" + familyPhysicianAddressLine2 + ", familyPhysicianContactNumber="
				+ familyPhysicianContactNumber + ", familyPhysicianMobileNumber=" + familyPhysicianMobileNumber
				+ ", nriGstApplicableYn=" + nriGstApplicableYn + ", gstinNumber=" + gstinNumber
				+ ", communicationDetailsId=" + communicationDetailsId + ", caAddressLine1=" + caAddressLine1
				+ ", caAddressLine2=" + caAddressLine2 + ", caAddressLine3=" + caAddressLine3 + ", caAddressLine4="
				+ caAddressLine4 + ", caCity=" + caCity + ", caState=" + caState + ", caPincode=" + caPincode
				+ ", isCaPaSameYn=" + isCaPaSameYn + ", paAddressLine1=" + paAddressLine1 + ", paAddressLine2="
				+ paAddressLine2 + ", paAddressLine3=" + paAddressLine3 + ", paAddressLine4=" + paAddressLine4
				+ ", paCity=" + paCity + ", paState=" + paState + ", paPincode=" + paPincode + ", correspondanceAdd="
				+ correspondanceAdd + ", mobileNumber=" + mobileNumber + ", phoneNumberOfficeStd="
				...
				+ ", organisationTypeOther=" + organisationTypeOther + ", sourceIncomeOtherYn=" + sourceIncomeOtherYn
				...
				+ workingDurationMnth + ", annualIncome=" + annualIncome + ", fhAnyDiseaseYn=" + fhAnyDiseaseYn
				+ ", fhAnyDiseaseDetails=" + fhAnyDiseaseDetails + ", fhEtliPoliciesYn=" + fhEtliPoliciesYn
				+ ", familyHistory=" + familyHistory + ", appInsuranceAvailableYn=" + appInsuranceAvailableYn
				...
				+ appDisCiDate + ", detailsInsPolicyAvailableYn=" + detailsInsPolicyAvailableYn + ", ihSfRejectedYn="
				+ ihSfRejectedYn + ", ihSfRejectedReason=" + ihSfRejectedReason + ", ihSfSpecialRatePolicyYn="
				+ ihSfSpecialRatePolicyYn + ", ePolicyYn=" + ePolicyYn + ", insuranceHistory=" + insuranceHistory
				+ ", lifeStyleDetailsId=" + lifeStyleDetailsId + ", heightCms=" + heightCms + ", heightFeet="
				+ heightFeet + ", heightInches=" + heightInches + ", weightKg=" + weightKg + ", weightVariationYn="
				+ weightVariationYn + ", variationType=" + variationType + ", variationWeight=" + variationWeight
				+ ", weightVariationReasonDataId=" + weightVariationReasonDataId + ", qTravelOutsideYn="
				+ qTravelOutsideYn + ", qTravelOutsideCountryCode=" + qTravelOutsideCountryCode
				+ ", qTravelOutsideCountryOth=" + qTravelOutsideCountryOth + ", qPilotCoPilotYn=" + qPilotCoPilotYn
				+ ", qAdventurousHobbiesYn=" + qAdventurousHobbiesYn + ", qSkyDivingOrParachutingYn="
				+ qSkyDivingOrParachutingYn + ", qParaglidingOrHandglidingYn=" + qParaglidingOrHandglidingYn

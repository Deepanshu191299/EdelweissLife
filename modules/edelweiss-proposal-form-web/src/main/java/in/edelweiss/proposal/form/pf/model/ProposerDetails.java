...
public class ProposerDetails {
	...
	public String toString() {
		return "ProposerDetails [applicationNumber=" + applicationNumber + ", medQDetailsRowId=" + medQDetailsRowId
				+ ", diseaseName=" + diseaseName + ", diagnosisDate=" + diagnosisDate + ", treatmentDetails="
				+ treatmentDetails + ", questionNo=" + questionNo + ", dosageDetails=" + dosageDetails + ", doctorName="
				+ doctorName + ", furtherTestDate=" + furtherTestDate + ", anyComplications=" + anyComplications
				+ ", additionalRemarks=" + additionalRemarks + ", personalDetailsId=" + personalDetailsId
				+ ", titleDataId=" + titleDataId + ", detailTypeOf=" + detailTypeOf + ", firstName=" + firstName
				+ ", middleName=" + middleName + ", lastName=" + lastName + ", fullName=" + fullName + ", dob=" + dob
				+ ", isSmokerYn=" + isSmokerYn + ", genderDataId=" + genderDataId + ", maritalStatusDataId="
				+ maritalStatusDataId + ", panNumber=" + panNumber + ", aadharNumber=" + aadharNumber + ", fatherName="
				+ fatherName + ", motherName=" + motherName + ", nationalityDataId=" + nationalityDataId
				+ ", nationalityOther=" + nationalityOther + ", ageProofDataId=" + ageProofDataId + ", ageProofOther="
				+ ageProofOther + ", qualificationDataId=" + qualificationDataId + ", qualificationOther="
				+ qualificationOther + ", highestQualification=" + highestQualification + ", coursePursued="
				+ coursePursued + ", courseDuration=" + courseDuration + ", courseYear=" + courseYear
				+ ", courseCollege=" + courseCollege + ", familyPhysicianName=" + familyPhysicianName
				...
				+ ", familyPhysicianMobileNumber=" + familyPhysicianMobileNumber + ", nriGstApplicableYn="
				+ nriGstApplicableYn + ", gstinNumber=" + gstinNumber + ", communicationDetailsId="
				...
				+ ", paPincode=" + paPincode + ", correspondanceAdd=" + correspondanceAdd + ", mobileNumber="
				+ mobileNumber + ", phoneNumberOfficeStd=" + phoneNumberOfficeStd + ", phoneNumberOffice="
				+ phoneNumberOffice + ", phoneNumberHomeStd=" + phoneNumberHomeStd + ", phoneNumberHome="
				+ phoneNumberHome + ", emailId=" + emailId + ", facebookId=" + facebookId + ", linkedInId=" + linkedInId
				+ ", corporateEmailId=" + corporateEmailId + ", employmentDetailsId=" + employmentDetailsId
				+ ", empRowId=" + empRowId + ", employmentTypeDataId=" + employmentTypeDataId
				+ ", organisationTypeDataId=" + organisationTypeDataId + ", organisationTypeOther="
				+ organisationTypeOther + ", sourceIncomeOtherYn=" + sourceIncomeOtherYn + ", sourceIncomeOtherDetails="
				+ sourceIncomeOtherDetails + ", employerName=" + employerName + ", employerAddress=" + employerAddress
				+ ", businessNature=" + businessNature + ", designationHeld=" + designationHeld
				+ ", dutyNatureTypeDataId=" + dutyNatureTypeDataId + ", employCountTypeDataId=" + employCountTypeDataId
				+ ", workingDurationYear=" + workingDurationYear + ", workingDurationMnth=" + workingDurationMnth
				+ ", annualIncome=" + annualIncome + ", fhAnyDiseaseYn=" + fhAnyDiseaseYn + ", fhAnyDiseaseDetails="
				...
				+ covidDetails + ", diagnosisDetails=" + diagnosisDetails + "]";
	}

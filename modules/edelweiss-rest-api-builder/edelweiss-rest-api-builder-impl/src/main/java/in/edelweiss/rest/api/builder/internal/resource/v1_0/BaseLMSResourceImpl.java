...
public abstract class BaseLMSResourceImpl implements LMSResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/edelweiss-rest-api/v1.0/edelweiss/leadDetails' -d $'{"interestSessions": ___, "lead": ___, "quote": ___, "utm": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(description = "Adds lead details")
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "LMS")}
	)
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/edelweiss/leadDetails")
	@javax.ws.rs.POST
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseLMSResourceImpl.class);

<div id='lms-loader' style='display: none;'>
    ...
    <g fill="none" fill-rule="evenodd" transform="translate(1 1)">
        ...
        <path fill="#7ED321" fill-opacity=".92" d="M20.303 35.103L13.4 28.2a1.98 1.98 0 0 1 2.8-2.8l4.103 4.103a2.4 2.4 0 0 0 3.394 0L35.8 17.4a1.98 1.98 0 0 1 2.8 2.8L23.697 35.103a2.4 2.4 0 0 1-3.394 0z"/>
                ...
                <div class="wealth-form-box text-center w-100 error-blk hide"> 
                    <h4 class="text-center mb-3 error-msg"><liferay-ui:message key="no-response-from-api"></liferay-ui:message></h4> 
                </div>
                <div class="wealth-form-box text-center w-100 success-blk hide">                    
                    <h3 class="mb-3"> Thank you!!</h3>
                    <p class="success-msg py-2"  style="font-size: 18px;color: #6d6d6d;">Thank you for sharing your details with us.</p>
                    <p class="success-msg pb-3"  style="font-size: 18px;color: #6d6d6d;">Our Investment expert will get in touch with you soon to understand your life insurance needs.</p>
                </div>
            </div>
        </div>
    </div>

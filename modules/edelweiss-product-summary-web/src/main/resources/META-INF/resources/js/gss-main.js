...
renderPremiumAmountBreakup = function(){
    ...
    if(productName === 'Zindagi Protect Plus'){
        ...
        colName.appendChild(document.createTextNode("Total GST"));
        colName.classList.add("table-heading");
        gstTR.appendChild(colName);
        tableBody.appendChild(gstTR);
        var col1 = document.createElement("td");
        col1.appendChild(document.createTextNode(""));
        gstTR.appendChild(col1);
        var col2 = document.createElement("td");
        col2.appendChild(document.createTextNode(""));
        gstTR.appendChild(col2);
        var col3 = document.createElement("td");
        col3.appendChild(document.createTextNode(""));
        gstTR.appendChild(col3);
        var col4 = document.createElement("td");
        var _totalGSTAmt = premiumAmount - (_basePremiumAmount+_totalRiderPrice);
        col4.appendChild(document.createTextNode(LANG_MESSAGES["rupee-sign"].concat(" ").concat(Math.round(_totalGSTAmt).toLocaleString("en-IN"))));
        col4.classList.add("text-right");
        gstTR.appendChild(col4);
    }

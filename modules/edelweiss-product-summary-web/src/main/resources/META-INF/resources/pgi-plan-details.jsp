	...
	<div class="edto-summary-tiles mt-0">
		...
		<form>
			<div class="row">
				...
				<c:if test="${productName=='Premier Guaranteed Income'}">
					<div class="col-md-4 col-12">
						<p>
				...
				<!-- if policy option is 1 hide below div -->
				<div class="col-md-4 col-12" id="<portlet:namespace/>incomePayoutFrequencyDiv">
					<p>
						<liferay-ui:message key="income-payout-frequency-label" />
				...
				<c:if test="${productName=='Premier Guaranteed Income'}">
					<div class="col-md-4 col-12" id="<portlet:namespace/>maturityPayoutOptionDiv">
						<p>
							<liferay-ui:message key="maturity-payoyt-option-label" />
							<span>${maturityPayoutOptionPicklist[summaryData.customerInvestmentDetailsRel[0].payoutOption]}</span>
						</p>
					</div>
				</c:if>
				<%-- <div class="col-md-4 col-12">

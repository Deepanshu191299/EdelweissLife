			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-12 p-0">
				<div class="premium-text">
					...
					<h1 id="<portlet:namespace/>premiumAmountContainer">
						...
						<c:choose>
							<c:when test="${paymentFrequencyPicklist[summaryData.customerInvestmentDetailsRel[0].paymentFrequency] == 'Monthly'}">
...
<%@ include file="/gfs/gfs-premium-amount-breakup-model.jsp"%>
jQuery(document).ready(function() {
	...
	function initEditBasicDetailModalFormValidation(){
		...
		summaryFormMessageFields[dateOfBirthValidator] = {
		    ...
		    minAge: 'Age should be between 18 to 60',
		    maxAge: 'Age should be between 18 to 60'
		};
	...
	function initEditBasicDetailModalFormValidationRules() {
		...
		var relationValueParam = $('input[type=radio][name='+assuredRelation+']:checked').data("name") + "'s";

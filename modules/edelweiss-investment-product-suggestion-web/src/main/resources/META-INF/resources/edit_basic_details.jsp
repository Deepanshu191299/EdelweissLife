                 		...
                 		<div class="radio_container">
                                <c:forEach var="curInvestingFor" items="${productIPSData['investingForData']}">
                                	<li class="btn form-btn p-0 address-radio">
                                		<input type="radio" name="<portlet:namespace/>basicInvestingFor" id="${curInvestingFor.key}" value="${curInvestingFor.name}" ${(productIPSData['productDefaultValueData'].investingFor.name == curInvestingFor.name || (empty basicDetailsMap['basicInvestingFor'] && curInvestingFor.name == 'Myself')) ? 'checked' : ''}>
